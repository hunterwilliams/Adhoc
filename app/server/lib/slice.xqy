...
<slice:slice-lookup>
  <slice:namespaces>
    <slice:namespace>
      <slice:abbrv>t</slice:abbrv>
      <slice:uri>test</slice:uri>
    </slice:namespace>
  </slice:namespaces>
  <slice:from>
    <slice:type>test</slice:type>
    <slice:to>
      <slice:type>t:test2type</slice:type>
      <slice:from-field>t:foreign-id</slice:from-field>
      <slice:to-field>t:id</slice:to-field>
    </slice:to>
  </slice:from>
</slice:slice-lookup>;
